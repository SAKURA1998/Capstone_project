...
void loop() {
 ...
 while(1){ 
   unsigned int value1 = sine256[index1++]*258;
      unsigned int value2 = sine256[index2++]*258;
  dac.updateChannel(1,value1);
  dac.updateChannel(0,value2);
  dac.updateChannel(2,value2);
  index1+= 150;
  if(index1 >= 255){
    index1 -= 255;
    }
